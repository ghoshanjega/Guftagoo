...
class Debate extends Component{
    ...
    render() {
        ...
        return (<div>
            ...
            <FlatButton backgroundColor = {forColor} style = {{color:"#FFFFFF"}} label="For" onClick={() => this.props.toggleDrawerFor()}/>
            <FlatButton backgroundColor = {againstColor} style = {{color:"#FFFFFF"}}  label="Against" onClick={() => this.props.toggleDrawerAgainst()} style={{float:"right"}}/>
